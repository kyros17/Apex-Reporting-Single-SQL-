...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1314681584117947735)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2566521484683304796)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(2566521558142304796)
,p_name=>'Projects'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566521785091304801)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566521862729304803)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566521987654304803)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566522089024304803)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566522163534304803)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566522264534304803)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566522378618304803)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566522474355304803)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566522557184304804)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2566564760226307121)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2681601080467982779)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2202066419295841718)
...
wwv_flow_imp_page.create_worksheet_pivot(
 p_id=>wwv_flow_imp.id(2202066803839841723)
,p_report_id=>wwv_flow_imp.id(2202066419295841718)
,p_pivot_columns=>'ASSIGNED_TO'
,p_row_columns=>'PROJECT'
);
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(2202067188742841724)
,p_pivot_id=>wwv_flow_imp.id(2202066803839841723)
,p_display_seq=>1
,p_function_name=>'SUM'
,p_column_name=>'COST'
...
wwv_flow_imp_page.create_worksheet_pivot_agg(
 p_id=>wwv_flow_imp.id(2202067588736841724)
,p_pivot_id=>wwv_flow_imp.id(2202066803839841723)
,p_display_seq=>2
,p_function_name=>'SUM'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2566683971570329385)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2566763460236382893)
,p_application_user=>'APXWS_ALTERNATIVE'
...
wwv_flow_imp_page.create_worksheet_computation(
 p_id=>wwv_flow_imp.id(2681620865838997470)
,p_report_id=>wwv_flow_imp.id(2566763460236382893)
...
wwv_flow_imp_page.create_worksheet_group_by(
 p_id=>wwv_flow_imp.id(2681620969037997470)
,p_report_id=>wwv_flow_imp.id(2566763460236382893)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2681620283022992920)
,p_application_user=>'APXWS_ALTERNATIVE'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(2681620478741992920)
,p_report_id=>wwv_flow_imp.id(2681620283022992920)
,p_name=>'Over Budget'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1334516978594926856)
,p_plug_name=>'SQL Source'
,p_parent_plug_id=>wwv_flow_imp.id(2566521484683304796)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6287190414491280108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2660127466415144940)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2566521484683304796)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(217169384825074537)
,p_name=>'Refresh on Edit'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(2566521484683304796)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(217169443483074538)
,p_event_id=>wwv_flow_imp.id(217169384825074537)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2566521484683304796)
);
