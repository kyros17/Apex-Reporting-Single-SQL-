...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(608996992014678567)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(608997162967678568)
,p_region_id=>wwv_flow_imp.id(608996992014678567)
,p_chart_type=>'donut'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(608997216501678569)
,p_chart_id=>wwv_flow_imp.id(608997162967678568)
,p_seq=>10
,p_name=>'Tasks'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(608997543508678572)
,p_plug_name=>'SQL Source'
,p_parent_plug_id=>wwv_flow_imp.id(608996992014678567)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1314442582615967750)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1314614071399600486)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2161625440293697489)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1314442167762967749)
,p_plug_name=>'Interactive Report Query Based on Current User''s Session'
,p_parent_plug_id=>wwv_flow_imp.id(2161625440293697489)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1314445362762998845)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1314445468021998845)
,p_name=>'Interactive Report'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314445787620998848)
,p_db_column_name=>'ID'
,p_display_order=>2
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314445888504998849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314445959964998849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314446083549998849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314446184213998849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314446288725998849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314446367913998849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314446474420998849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314446573632998849)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1314446662915998849)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1314446763455999075)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(1334866886062268924)
,p_report_id=>wwv_flow_imp.id(1314446763455999075)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(1334866961717268924)
,p_report_id=>wwv_flow_imp.id(1314446763455999075)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'COST'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(1334867087714268924)
,p_report_id=>wwv_flow_imp.id(1314446763455999075)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1334521383301970182)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1314613468498590106)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1314445362762998845)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1314880663977505255)
,p_name=>'get chart data from IR result'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1314445362762998845)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1314880961997505260)
,p_event_id=>wwv_flow_imp.id(1314880663977505255)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1314881676330508477)
,p_event_id=>wwv_flow_imp.id(1314880663977505255)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(608996992014678567)
);
