...
,p_group_id=>wwv_flow_imp.id(668882883608959466)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1877067849275867866)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1877068649529867867)
,p_plug_name=>'items'
,p_parent_plug_id=>wwv_flow_imp.id(1877067849275867866)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1587326709574120498)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1877068246878867866)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1877071570748867872)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1877069751283867869)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1877071570748867872)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1877070117672867870)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1877072619654867875)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1877070117672867870)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1877068902783867867)
,p_name=>'P34_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1877068649529867867)
...
,p_field_template=>wwv_flow_imp.id(1587359750207120587)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1877072169373867874)
...
,p_process_when_button_id=>wwv_flow_imp.id(1877070117672867870)
