...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1314683977500993141)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2678887876770400311)
,p_plug_name=>'Filter'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2678888662576400313)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2679024676380410868)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679024882831410869)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679024956770410869)
,p_query_column_id=>2
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679025085694410869)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679025172067410869)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679025256820410869)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679025359522410869)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679025465867410869)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679025561881410869)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679025681321410869)
,p_query_column_id=>9
,p_column_alias=>'COST'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2679025758820410869)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1334517983110939945)
,p_plug_name=>'SQL Source'
,p_parent_plug_id=>wwv_flow_imp.id(2679024676380410868)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2679411282791450551)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2678888662576400313)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2678889287848400317)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2678888074668400311)
,p_name=>'P5_ASSIGNEE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2678887876770400311)
,p_prompt=>'Assigned To'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cMaxlength=>4000
,p_field_template=>wwv_flow_imp.id(1871481747342908560)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2678888273450400312)
,p_name=>'P5_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2678887876770400311)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2679112765775417215)
,p_name=>'P5_STATUS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2678887876770400311)
,p_prompt=>'Status'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2694964485221045427)
,p_name=>'P5_ROWS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2678887876770400311)
,p_item_default=>'15'
...
,p_lov=>'.'||wwv_flow_imp.id(2695028081542053822)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2680550563378643627)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2680550872293643628)
,p_event_id=>wwv_flow_imp.id(2680550563378643627)
,p_event_result=>'TRUE'
