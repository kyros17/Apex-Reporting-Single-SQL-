...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1640514186457887673)
,p_plug_name=>'APEX Communities and Resources'
...
,p_plug_source=>'<p>Demonstration of reports and reporting techniques in Oracle APEX. Made Changes 11.27</p>'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3167641581374965492)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3167657073237999667)
...
,p_list_id=>wwv_flow_imp.id(3167654687941997854)
