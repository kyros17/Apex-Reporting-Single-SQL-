...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1334514967176916880)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(623967554300142233)
,p_plugin_id=>wwv_flow_imp.id(1334514967176916880)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(623967927805142234)
,p_plugin_id=>wwv_flow_imp.id(1334514967176916880)
,p_attribute_scope=>'COMPONENT'
