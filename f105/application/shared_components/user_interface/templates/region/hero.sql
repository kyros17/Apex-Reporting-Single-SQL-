...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1577229058173032139)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703679604059064389)
,p_plug_template_id=>wwv_flow_imp.id(1577229058173032139)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703680045109064389)
,p_plug_template_id=>wwv_flow_imp.id(1577229058173032139)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703680601186064390)
,p_plug_template_id=>wwv_flow_imp.id(1577229058173032139)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703681052367064390)
,p_plug_template_id=>wwv_flow_imp.id(1577229058173032139)
,p_name=>'Sub Regions'
