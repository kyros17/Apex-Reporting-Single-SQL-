...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1587332857993120506)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713783403879152756)
,p_plug_template_id=>wwv_flow_imp.id(1587332857993120506)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713783844929152756)
,p_plug_template_id=>wwv_flow_imp.id(1587332857993120506)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713784401006152757)
,p_plug_template_id=>wwv_flow_imp.id(1587332857993120506)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713784852187152757)
,p_plug_template_id=>wwv_flow_imp.id(1587332857993120506)
,p_name=>'Sub Regions'
