...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(713905577333152868)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713906017191152869)
,p_plug_template_id=>wwv_flow_imp.id(713905577333152868)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713906511887152869)
,p_plug_template_id=>wwv_flow_imp.id(713905577333152868)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713907036243152869)
,p_plug_template_id=>wwv_flow_imp.id(713905577333152868)
,p_name=>'Sub Regions'
