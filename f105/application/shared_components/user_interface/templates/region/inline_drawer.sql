...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(297030001956044113)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713817342402152791)
,p_plug_template_id=>wwv_flow_imp.id(297030001956044113)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713817815926152791)
,p_plug_template_id=>wwv_flow_imp.id(297030001956044113)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713818380805152792)
,p_plug_template_id=>wwv_flow_imp.id(297030001956044113)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713818867621152792)
,p_plug_template_id=>wwv_flow_imp.id(297030001956044113)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713819375317152792)
,p_plug_template_id=>wwv_flow_imp.id(297030001956044113)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713819892470152793)
,p_plug_template_id=>wwv_flow_imp.id(297030001956044113)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713820355769152793)
,p_plug_template_id=>wwv_flow_imp.id(297030001956044113)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713820861735152793)
,p_plug_template_id=>wwv_flow_imp.id(297030001956044113)
,p_name=>'Sub Regions'
