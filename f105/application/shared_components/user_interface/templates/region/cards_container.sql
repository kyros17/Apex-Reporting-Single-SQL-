...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(648520782103500446)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713715284654152690)
,p_plug_template_id=>wwv_flow_imp.id(648520782103500446)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713715726039152690)
,p_plug_template_id=>wwv_flow_imp.id(648520782103500446)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713716251782152691)
,p_plug_template_id=>wwv_flow_imp.id(648520782103500446)
,p_name=>'Sub Regions'
