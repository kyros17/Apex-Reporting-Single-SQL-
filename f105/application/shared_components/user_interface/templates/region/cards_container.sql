...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(638416982283412079)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703611484834064323)
,p_plug_template_id=>wwv_flow_imp.id(638416982283412079)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703611926219064323)
,p_plug_template_id=>wwv_flow_imp.id(638416982283412079)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703612451962064324)
,p_plug_template_id=>wwv_flow_imp.id(638416982283412079)
,p_name=>'Sub Regions'
