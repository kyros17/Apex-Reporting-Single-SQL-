...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1577229571783032141)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703643240488064355)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703643761621064355)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703644300237064356)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703644803693064356)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703645247178064356)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703645775576064357)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703646228168064357)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703646752350064357)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703647303106064358)
,p_plug_template_id=>wwv_flow_imp.id(1577229571783032141)
,p_name=>'Sub Regions'
