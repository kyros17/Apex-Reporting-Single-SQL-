...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1582275512527974026)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708689181233006240)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708689702366006240)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708690240982006241)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708690744438006241)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708691187923006241)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708691716321006242)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708692168913006242)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708692693095006242)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708693243851006243)
,p_plug_template_id=>wwv_flow_imp.id(1582275512527974026)
,p_name=>'Sub Regions'
