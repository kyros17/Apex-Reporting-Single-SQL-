...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1587333371603120508)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713747040308152722)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713747561441152722)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713748100057152723)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713748603513152723)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713749046998152723)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713749575396152724)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713750027988152724)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713750552170152724)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713751102926152725)
,p_plug_template_id=>wwv_flow_imp.id(1587333371603120508)
,p_name=>'Sub Regions'
