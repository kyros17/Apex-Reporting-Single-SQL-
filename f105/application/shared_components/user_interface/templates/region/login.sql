...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1587336342538120513)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713847982916152818)
,p_plug_template_id=>wwv_flow_imp.id(1587336342538120513)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713848509889152818)
,p_plug_template_id=>wwv_flow_imp.id(1587336342538120513)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713848934774152818)
,p_plug_template_id=>wwv_flow_imp.id(1587336342538120513)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713849424693152818)
,p_plug_template_id=>wwv_flow_imp.id(1587336342538120513)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713849913270152819)
,p_plug_template_id=>wwv_flow_imp.id(1587336342538120513)
,p_name=>'Sub Regions'
