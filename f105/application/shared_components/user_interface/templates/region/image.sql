...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(541299704248503047)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713790314929152764)
,p_plug_template_id=>wwv_flow_imp.id(541299704248503047)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713790907451152765)
,p_plug_template_id=>wwv_flow_imp.id(541299704248503047)
,p_name=>'Sub Regions'
