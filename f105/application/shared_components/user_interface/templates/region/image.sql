...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(531195904428414680)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703686515109064397)
,p_plug_template_id=>wwv_flow_imp.id(531195904428414680)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703687107631064398)
,p_plug_template_id=>wwv_flow_imp.id(531195904428414680)
,p_name=>'Sub Regions'
