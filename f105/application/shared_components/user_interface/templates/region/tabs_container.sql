...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1860550627185819359)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703777791834064481)
,p_plug_template_id=>wwv_flow_imp.id(1860550627185819359)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703778260646064481)
,p_plug_template_id=>wwv_flow_imp.id(1860550627185819359)
,p_name=>'Tabs'
