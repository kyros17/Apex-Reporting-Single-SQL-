...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1870654427005907726)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713881591654152848)
,p_plug_template_id=>wwv_flow_imp.id(1870654427005907726)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713882060466152848)
,p_plug_template_id=>wwv_flow_imp.id(1870654427005907726)
,p_name=>'Tabs'
