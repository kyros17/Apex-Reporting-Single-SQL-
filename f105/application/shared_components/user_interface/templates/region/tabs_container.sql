...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1865596567930761244)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708823732579006366)
,p_plug_template_id=>wwv_flow_imp.id(1865596567930761244)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708824201391006366)
,p_plug_template_id=>wwv_flow_imp.id(1865596567930761244)
,p_name=>'Tabs'
