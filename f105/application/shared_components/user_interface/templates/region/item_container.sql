...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(703806102671064505)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703806566441064506)
,p_plug_template_id=>wwv_flow_imp.id(703806102671064505)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703807093352064506)
,p_plug_template_id=>wwv_flow_imp.id(703806102671064505)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703807561875064506)
,p_plug_template_id=>wwv_flow_imp.id(703806102671064505)
,p_name=>'Button Start'
