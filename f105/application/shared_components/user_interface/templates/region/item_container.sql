...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708852043416006390)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708852507186006391)
,p_plug_template_id=>wwv_flow_imp.id(708852043416006390)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708853034097006391)
,p_plug_template_id=>wwv_flow_imp.id(708852043416006390)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708853502620006391)
,p_plug_template_id=>wwv_flow_imp.id(708852043416006390)
,p_name=>'Button Start'
