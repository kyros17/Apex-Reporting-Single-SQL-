...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(713909902491152872)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713910366261152873)
,p_plug_template_id=>wwv_flow_imp.id(713909902491152872)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713910893172152873)
,p_plug_template_id=>wwv_flow_imp.id(713909902491152872)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713911361695152873)
,p_plug_template_id=>wwv_flow_imp.id(713909902491152872)
,p_name=>'Button Start'
