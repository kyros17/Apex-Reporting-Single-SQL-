...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1587317660082120471)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713663272115152637)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713663761235152637)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713664259228152638)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713664766774152638)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713665310052152638)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713665714664152639)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713666218995152639)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713666742294152639)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713667238557152640)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713667769679152640)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713668279813152640)
,p_page_template_id=>wwv_flow_imp.id(1587317660082120471)
