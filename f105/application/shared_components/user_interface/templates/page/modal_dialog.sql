...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1587310660465120462)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713656495531152631)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713656921287152632)
,p_page_template_id=>wwv_flow_imp.id(1587310660465120462)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713657494218152632)
,p_page_template_id=>wwv_flow_imp.id(1587310660465120462)
