...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1577206860645032095)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703552695711064264)
,p_page_template_id=>wwv_flow_imp.id(1577206860645032095)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703553121467064265)
,p_page_template_id=>wwv_flow_imp.id(1577206860645032095)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(703553694398064265)
,p_page_template_id=>wwv_flow_imp.id(1577206860645032095)
