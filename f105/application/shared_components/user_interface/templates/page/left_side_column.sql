...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1587294096379120382)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713610552721152595)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713611013058152596)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713611580243152596)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713612031896152596)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713612523469152597)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713613023015152597)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713613555392152597)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713614016613152598)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713614595889152598)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713615052994152598)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713615583814152599)
,p_page_template_id=>wwv_flow_imp.id(1587294096379120382)
