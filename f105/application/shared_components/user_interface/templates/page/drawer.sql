...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(296833563575044312)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713600419291152586)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713600910478152587)
,p_page_template_id=>wwv_flow_imp.id(296833563575044312)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(713601492744152587)
,p_page_template_id=>wwv_flow_imp.id(296833563575044312)
