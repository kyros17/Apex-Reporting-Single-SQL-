...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1309626118425846659)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2673830017695253829)
,p_plug_name=>'Filter'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2673830803501253831)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2673966817305264386)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967023756264387)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967097695264387)
,p_query_column_id=>2
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967226619264387)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967312992264387)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967397745264387)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967500447264387)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967606792264387)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967702806264387)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967822246264387)
,p_query_column_id=>9
,p_column_alias=>'COST'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2673967899745264387)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1329460124035793463)
,p_plug_name=>'SQL Source'
,p_parent_plug_id=>wwv_flow_imp.id(2673966817305264386)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2674353423716304069)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2673830803501253831)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2673831428773253835)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2673830215593253829)
,p_name=>'P5_ASSIGNEE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2673830017695253829)
,p_prompt=>'Assigned To'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cMaxlength=>4000
,p_field_template=>wwv_flow_imp.id(1866423888267762078)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2673830414375253830)
,p_name=>'P5_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2673830017695253829)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2674054906700270733)
,p_name=>'P5_STATUS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2673830017695253829)
,p_prompt=>'Status'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2689906626145898945)
,p_name=>'P5_ROWS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2673830017695253829)
,p_item_default=>'15'
...
,p_lov=>'.'||wwv_flow_imp.id(2689970222466907340)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2675492704303497145)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2675493013218497146)
,p_event_id=>wwv_flow_imp.id(2675492704303497145)
,p_event_result=>'TRUE'
