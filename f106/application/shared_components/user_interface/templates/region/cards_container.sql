...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(643462923028353964)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708657425579006208)
,p_plug_template_id=>wwv_flow_imp.id(643462923028353964)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708657866964006208)
,p_plug_template_id=>wwv_flow_imp.id(643462923028353964)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708658392707006209)
,p_plug_template_id=>wwv_flow_imp.id(643462923028353964)
,p_name=>'Sub Regions'
