...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1582274998917974024)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708725544804006274)
,p_plug_template_id=>wwv_flow_imp.id(1582274998917974024)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708725985854006274)
,p_plug_template_id=>wwv_flow_imp.id(1582274998917974024)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708726541931006275)
,p_plug_template_id=>wwv_flow_imp.id(1582274998917974024)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708726993112006275)
,p_plug_template_id=>wwv_flow_imp.id(1582274998917974024)
,p_name=>'Sub Regions'
