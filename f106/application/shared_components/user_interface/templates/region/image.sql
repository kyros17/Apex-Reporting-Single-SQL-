...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(536241845173356565)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708732455854006282)
,p_plug_template_id=>wwv_flow_imp.id(536241845173356565)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708733048376006283)
,p_plug_template_id=>wwv_flow_imp.id(536241845173356565)
,p_name=>'Sub Regions'
